...
dd <- ggplot(subDepC, aes(x= bp, y=Depth)) +
  ...
  scale_y_continuous(limits=c(-825,750),labels=c("500","0","500"), breaks=c(-500,0,500),expand=c(0.01,0)) +
  theme(legend.position="none")

png(filename="Figure7cap1cap2.png", type="cairo",units="px", width=5600, 
...
png(filename="Figure7cap1cap3.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
dd
dev.off()
```
...
png(filename="Figure7cap1cap4.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
dd
dev.off()
```