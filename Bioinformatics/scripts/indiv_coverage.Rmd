...
knitr::opts_chunk$set(root.dir = "/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv/")
```
...
```{r Capture_B3, message=FALSE, warning=TRUE, include=FALSE}
...
plot_list <- list()
files <- c("Capture1.B3", "Capture2.B3", "Capture3.B3", "Capture4.B3")
for (file in files) {
  print(file)
...
ggsave(file="Figure2_indivnorm_B3.png", pcombined)
```

```{r Capture_B4, message=FALSE, warning=TRUE, include=FALSE}
setwd("/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv/")
# initialize an empty list to store ggplot objects
plot_list <- list()

files <- c("Capture1.B4", "Capture2.B4", "Capture3.B4", "Capture4.B4")
...
#save the combined plot as PNG file
ggsave(file="Figure2_indivnorm_B4.png", pcombined)
```

```{r Capture_G3, message=FALSE, warning=TRUE, include=FALSE}
setwd("/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv")
# initialize an empty list to store ggplot objects
plot_list <- list()

files <- c("Capture1.G3", "Capture2.G3", "Capture3.G3", "Capture4.G3")
...
pcombined <- grid.arrange(grobs = plot_list, ncol = 2, top=textGrob("Capture B4 Read Depth across genome"))
#save the combined plot as PNG file
ggsave(file="Figure2_indivnorm_G3.png", pcombined)
```

```{r Capture_G5, message=FALSE, warning=TRUE, include=FALSE}
setwd("/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv")
# initialize an empty list to store ggplot objects
plot_list <- list()

files <- c("Capture1.G5", "Capture2.G5", "Capture3.G5", "Capture4.G5")
...
#save the combined plot as PNG file
ggsave(file="Figure2_indivnorm_G5.png", pcombined)
```
...
files <- c("Capture1.K3", "Capture2.K3", "Capture3.K3", "Capture4.K3")
...
files <- c("Capture1.K4", "Capture2.K4", "Capture3.K4", "Capture4.K4")
...
files <- c("Capture1.M3", "Capture2.M3", "Capture3.M3", "Capture4.M3")
...
files <- c("Capture1.M4", "Capture2.M4", "Capture3.M4", "Capture4.M4")
...
files <- c("Capture1.N2", "Capture2.N2", "Capture3.N2", "Capture4.N2")
...
```{r Capture 2, message=FALSE, warning=TRUE, include=FALSE}
# Set your working directory
setwd("/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv/")
...
```{r Capture 3, message=FALSE, warning=TRUE, include=FALSE}
# Set your working directory
setwd("/home/jgreen/eager_obj1a/04_coverage_analysis/01_genome_region/02_indiv/")
...
# Combine all the ggplot objects in the list using grid.arrange()
pcombined <- grid.arrange(grobs = plot_list, legend_p1, ncol = 2, top = textGrob("Read Depth Distribution across Captures"))
