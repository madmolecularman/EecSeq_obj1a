...
df1 <- read.table("Capture1_B3.insert.merged.ExonMeanCoverage.txt", header = TRUE)
df1 <-as.data.frame(df1)
df2 <- read.table("Capture2_B3.insert.merged.ExonMeanCoverage.txt", header = TRUE)
df2 <-as.data.frame(df2)
df3 <- read.table("Capture3_B3.insert.merged.ExonMeanCoverage.txt", header = TRUE)
df3 <-as.data.frame(df3)
df4 <- read.table("Capture4_B3.insert.merged.ExonMeanCoverage.txt", header = TRUE)
...
png(filename="Figure3_insert_norm_cap11.png", type="cairo",units="px", width=5600, 
...
png(filename="Figure3_insert_norm_B3_cap12.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
b1
dev.off()
```
...
png(filename="Figure3_insert_norm_B3_cap13.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
b2
dev.off()
```
...
png(filename="Figure3_insert_norm_B3_cap14.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
b3
dev.off()
```
...
png(filename="Figure3_insert_norm_B3cap24.png", type="cairo",units="px", width=5600, 
    height=3000, res=600, bg="transparent")
b4
dev.off() 
```
